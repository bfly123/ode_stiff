...
\hspace{2.cm}	$\left\{
  \begin{array}{rlr}
	...
	\end{array}
  \right.$}
  \hspace{0.0cm}{ \color{black!60} ! Averaging information} {\color{black!80}}
...
%	\setlenth{\fboxrule}{0pt}
%	\setlenth{\fboxsep}{0.2cm}
  \hspace{0cm}
  \begin{minipage}{7cm}
	\color{black!60}
...
%  \vspace{0.1cm}
%  \hspace{8.8cm} 
%  \color{black!60} ! Updating cell-point $(I,J)$'s  information by averaging
...
%\hspace{2.5cm} $il=1, ir=1$
%
%\hspace{2.5cm} {\color{black!60!blue!80}DO WHILE \color{black!60} $Mrk(i-il,j)= 0$}
%
%\hspace{3.cm} $il=il+1$
%
%\hspace{2.5cm} {\color{black!60!blue!80}ENDDO
%
%\hspace{2.5cm} {\color{black!60!blue!80}DO WHILE \color{black!60} $Mrk(i+ir,j)= 0$}
%
%\hspace{3.cm} $ir=ir+1$
%
%\hspace{2.5cm} \color{black!60!blue!80}ENDDO  
...
%\hspace{2.5cm} $jl=1, jr=1$
%
%\hspace{2.5cm} {\color{black!60!blue!80}DO WHILE \color{black!60} $Mrk(i,j-jl)= 0$}
%
%\hspace{3.cm} $jl=jl+1$
%
%\hspace{2.5cm} {\color{black!60!blue!80}ENDDO
%
%\hspace{2.5cm} {\color{black!60!blue!80}DO WHILE \color{black!60} $Mrk(i,j+jr)= 0$}
%
%\hspace{3.cm} $jr=jr+1$
%
%\hspace{2.5cm} {\color{black!60!blue!80}ENDDO
...
\hspace{0.5cm} 
\small
Solving the reaction equations (\ref{Rfrac}) to get new $z$ and $z_p$ by using $\hat{z}$
...
%\color{black!60} \hspace{7.45cm} ! The END
\end{spacing}
%
\end{document}
